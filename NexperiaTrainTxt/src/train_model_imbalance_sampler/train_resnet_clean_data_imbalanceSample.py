...
from tools.common_tools import ModelTrainer, show_confMat, plot_line, cal_auc_train, cal_focal_loss_alpha
...
if __name__ == "__main__":
    ...
    # remote server
    train_dir = os.path.join(BASE_DIR, "../..", "..", "..", "Data", "batch_2_noneRepeat", "train")
    test_dir = os.path.join(BASE_DIR, "../..", "..", "..", "Data", "batch_2_noneRepeat", "val")



    now_time = datetime.now()
    time_str = datetime.strftime(now_time, '%m-%d_%H-%M')
    time_str = time_str + "_S_CE" + "_N-Pre" + "_res34" + "_clean_B2_imbalanceS"
    ...
    alpha = cal_focal_loss_alpha(train_data)
    ...
    ######ResNet34#######
    resnet_model = models.resnet34(num_classes=num_classes)
...
# ============================ step 5/5 训练 ============================
    ...
    for epoch in range(start_epoch + 1, MAX_EPOCH):
        ...
        roc_auc_train, pr_auc_train, fpr_train = cal_auc_train(y_true_train, y_outputs_train)
        roc_auc_valid, pr_auc_valid, fpr_valid = cal_auc_train(y_true_valid, y_outputs_valid)
